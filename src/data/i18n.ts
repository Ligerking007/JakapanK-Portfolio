...
const english: LocalizedContent = {
  ...
  skillCategories: [
    { title: 'Backend', skills: ['C#', '.NET', '.NET Core API', 'ASP.NET MVC', 'Node.js', 'TypeScript'] },
    { title: 'Frontend', skills: ['React', 'Angular', 'JavaScript', 'jQuery', 'Bootstrap', 'Tailwind CSS'] },
    { title: 'Mobile', skills: ['Android Kotlin', 'Android Java', 'iOS Swift', 'Azure Communication Services'] },
    { title: 'DevOps & Cloud', skills: ['Azure', 'Docker', 'Kubernetes', 'CI/CD', 'TeamCity', 'Octopus', 'GitHub Actions'] },
    { title: 'Database & Reporting', skills: ['Microsoft SQL Server', 'PostgreSQL', 'SQLite', 'Crystal Reports', 'RDLC', 'SSRS'] },
    { title: 'Quality & Process', skills: ['Agile', 'Scrum', 'Jira', 'Code Review', 'SonarQube', 'Selenium', 'UML'] },
    { title: 'UI Frameworks', skills: ['Telerik', 'DevExpress', 'Kendo UI', 'MDBootstrap', 'AJAX'] },
...
const thai: LocalizedContent = {
  ...
  sections: {
    about: {
      eyebrow: 'เกี่ยวกับ',
      title: 'ผู้นำทีมเทคนิคที่ยังลงมือพัฒนาเอง',
